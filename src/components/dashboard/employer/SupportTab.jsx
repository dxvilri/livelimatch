import { 
    PlusIcon, TrashIcon, ChatBubbleLeftRightIcon, ChevronLeftIcon, 
    CpuChipIcon, MegaphoneIcon, XMarkIcon, PaperClipIcon, PaperAirplaneIcon 
} from "@heroicons/react/24/outline";

export default function SupportTab({
    supportTickets, activeSupportTicket, setActiveSupportTicket,
    ticketMessage, setTicketMessage, supportAttachment, setSupportAttachment,
    isSupportUploading, isSupportOpen, setIsSupportOpen,
    handleSendSupportMessage, handleCloseSupportTicket, handleDeleteTicket,
    handleSendFAQ, handleSupportFileSelect, supportFileRef, ticketScrollRef,
    isBotTyping, darkMode, isMobile, BOT_FAQ
}) {
    ...
    return (
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-6 animate-content mt-4 md:mt-8 ${isMobile ? (isSupportOpen ? 'h-screen pb-0' : 'h-[calc(100vh-14rem)] pb-2') : 'h-[calc(100vh-10rem)]'}`}>
